...
public class CustomerTable extends javax.swing.JFrame {
    ...
    public CustomerTable(ArrayList<CustomerServiceModel> customerArray)
    {
        initComponents();
        ...
        this.setExtendedState(CustomerTable.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Select the Record You want to Update ");

        btnUpdate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnUpdate.setForeground(new java.awt.Color(204, 51, 0));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Please select any one row to update");
        }
